...
## using the function to calculate the GDP of Denmark in the specific years

a <- calc_GDP(gapminder, year = 1967, country="Denmark")
b <- calc_GDP(gapminder, year = 1977, country="Denmark")
c <- calc_GDP(gapminder, year = 1987, country="Denmark")
d <- calc_GDP(gapminder, year = 1997, country="Denmark")
e <- calc_GDP(gapminder, year = 2007, country="Denmark")
f <- calc_GDP(gapminder, year = 2017, country="Denmark")

## binding the calculations into one table
